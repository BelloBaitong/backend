...
export class AutoMigration1774521093903 implements MigrationInterface {
    name = 'AutoMigration1774521093903'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "course" ADD "descriptionExpand" text`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "course" DROP COLUMN "descriptionExpand"`);
